...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action='{{ route('desa.produk.update') }}' class="form-horizontal" method='POST' enctype="multipart/form-data">
                <input type="hidden" name="id" value="{{ $produk->id }}">
                {{ csrf_field() }}
                <label class='control-label' for='title'>Nama Produk</label>
                <input id="title" type="text" size='50' style='width:auto;' class="form-control" name="nama" value="{{ $produk->nama }}"
                    required autofocus>
                <label class='control-label' for='content'>Deskripsi Produk</label>
                <textarea id="content" rows='5' class="form-control" name="konten">{{ $produk->konten }}</textarea>
