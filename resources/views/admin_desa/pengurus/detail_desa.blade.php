  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span class='glyphicon glyphicon-exclamation-sign'></span> Set Pengurus</h4>
      </div>
      <div class="modal-body">
        <p>Anda yakin ingin menjadikan user ini sebagai Pengurus <strong>Desa {{ $desa->nama }}</strong> ?</p>
      </div>
      <div class="modal-footer">
        <button type="button" id='btn-set-pengurus' class="btn btn-sm  btn-success"><span class='glyphicon glyphicon-check'></span> Ya</button>
