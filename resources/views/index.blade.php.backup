                    ...
                    @foreach($stories as $story)
                        <div class='panel story panel-default'>
                            ...
                            <div class='panel-heading'>
                                <img height='25' class='img-rounded' src='{{ $story->user->photo ? url('/storage/'.$story->user->photo) : url('/photos/av-default.jpg') }}'/>

                                <strong><a href='{{ $story->user->username }}'>{{ $story->user->name }}</a></strong>
                            ...
                            <div class="panel-footer">
                                <span class="text-muted"><i class="glyphicon glyphicon-time"></i>&nbsp;&nbsp;{{ Date::parse($story->created_at)->ago() }} &bull; </span> <span class="pull-right"><i class='glyphicon glyphicon-comment'></i> <strong>{{ count($story->comment) }}</strong></span>
                            </div>
                        </div>
                    @endforeach
                </div>
