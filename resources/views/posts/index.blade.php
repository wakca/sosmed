<div class="panel panel-default">
    <div class="panel-body">
        ...
        <form id='postForm' action='/post' class="form-horizontal" method='POST' enctype="multipart/form-data">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            <textarea class="form-control" id='content' name='content' rows='3' placeholder="Apa yang baru hari ini ?" required></textarea>
            <input type='hidden' id='user_id' name='user_id' value='{{ Auth::Id() }}'/>
            <input type='hidden' id='recepient_id' name='recepient_id' value='{{ Auth::Id() }}'/>
...
@section('script')
    ...
    <script type='text/javascript'>        
        ...
        function getNewPost() {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    window.setTimeout(getNewPost, 1100);
                }
            });
        }
        ...
        function ajaxTime() {
            var timepost = "[";
            $(".ajax-time").each(function(){
                $postId = $(this).data('time-post-id');
                $v = $(this).data('time').replace(' ','_');
                timepost += "{\"id\":\""+$postId+"\", \"time\":\""+$v+"\"},";
            });
            timepost += "]";
